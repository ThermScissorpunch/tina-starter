...
> **TL;DR:**
> - Isabelle Udo van videOrbit Studio brengt AR, AI en mode samen in unieke digitale ervaringen
> - Ze was een van de eersten die augmented reality toepaste in de mode-industrie (sinds 2019)
> - Samenwerkingen met Dior, Burberry, Versace en L’Oréal tonen de impact van digitale kunst
> - Future Front Row bracht digitale modehuizen naar de catwalk van Amsterdam Fashion Week
> - Haar advies: deel je werk openlijk en focus op je passie
...
## Hoe zet Isabelle AR en AI in voor mode?
...
## Met welke grote merken werkt Isabelle samen?
...
Benieuwd naar andere creatieve carrières? Luister ook naar [Karim Flores Afifi over het navigeren tussen mode en muziek](/features/podcasts-navigating-industries).

## Wat is Isabelle’s advies voor jonge creatieven?
...
Ontdek ook hoe [set designer Gini Grootenboer haar creatieve pad vond](/features/what-does-a-set-designer-do) in de mode- en kunstwereld.
...
## Veelgestelde vragen over AR en mode

### Wat is augmented reality in de mode-industrie?

Augmented reality (AR) voegt digitale elementen toe aan de echte wereld, bijvoorbeeld via je telefoon. In mode wordt AR gebruikt voor virtuele try-ons, interactieve campagnes en digitale modeshows. Isabelle Udo was een van de eersten die AR toepaste in fashion, met projecten voor merken als Dior en Burberry.

### Hoe beïnvloedt AI de modewereld?

AI wordt steeds vaker ingezet voor het creëren van visuele content, van digitale ontwerpen tot videoproducties. Tools als Stable Diffusion maken het mogelijk om snel nieuwe visuele concepten te ontwikkelen. Voor creatieven als Isabelle biedt AI nieuwe mogelijkheden om hun artistieke visie sneller en breder te realiseren.

### Wat was het Future Front Row project?

Future Front Row was een project dat digitale mode tastbaar maakte via interactieve modeshows. Isabelle bracht digitale modehuizen samen op de catwalk van Amsterdam Fashion Week in samenwerking met Felix Meritis. Het gaf digitale ontwerpers een podium en maakte deze nieuwe vorm van mode toegankelijk voor een breder publiek.
